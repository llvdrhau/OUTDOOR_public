...
class YieldReactor(PhysicalProcess):
    ...
    This Class models yield reactors, which inherit from the PhysicalProcess
    class. Therefore, they includes capital costs factors, energy demand factors and
    mass balance factors. 
    This class adds parameters to calculated mass-based yield reactions
    based on yield factors and inert components which are not transformed by the
    yield function.
    """
